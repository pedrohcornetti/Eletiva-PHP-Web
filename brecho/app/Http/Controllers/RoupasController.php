...
class RoupasController extends Controller
{
    ...
    {
        $roupa = Roupas::findOrFail($id); // Busca a roupa pelo ID ou retorna erro 404
        return view('roupas.edit', compact('roupa')); // Envia para a view
    }
...
{
    $roupa = Roupas::findOrFail($id); // Busca a roupa pelo ID
    ...
    // Atualiza a roupa no banco de dados
